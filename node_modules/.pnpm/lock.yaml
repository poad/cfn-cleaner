...
packages:
  ...
  /@aws-sdk/client-cloudformation@3.526.0:
    resolution: {integrity: sha512-Zz6swHfQdauuCJY3j+5SUPMFWTxgpAWN3x5dl/8jdn0Q1GdiWzZ0/5+jZr83mE7ola3UUH3LP/cw1UIljJO0ZA==}
    engines: {node: '>=14.0.0'}
    dependencies:
      '@aws-crypto/sha256-browser': 3.0.0
      '@aws-crypto/sha256-js': 3.0.0
      ...
      '@smithy/util-defaults-mode-node': 2.2.4
  ...
  /@smithy/credential-provider-imds@2.2.5:
    resolution: {integrity: sha512-OxgD7jX6bjDJNYsjKCZN+PBVy3ZNiXGhysOtfaV1+WGSmbJJWkw613BQaY0iDAxVxUNTt30Lt3NyhimAAsZ3TA==}
    engines: {node: '>=14.0.0'}
    dependencies:
      '@smithy/node-config-provider': 2.2.4
      '@smithy/property-provider': 2.1.3
  ...
  /@smithy/util-defaults-mode-node@2.2.4:
    resolution: {integrity: sha512-dvBhPpjpIdGKyJZZ0STFCcvak79Q6brgyZhsebfiAX/zB5paYuqmkG6hMUW7QqZFQ7kCldtOUzwV75MuXaiuhA==}
    engines: {node: '>= 10.0.0'}
    dependencies:
      '@smithy/config-resolver': 2.1.4
      '@smithy/credential-provider-imds': 2.2.5
